...
const LiveClockWithCharacter = ({ userName, userGreeting, userIcon, userMotivation }) => {
  ...
  const getTheme = () => {
    ...
    if (hour >= 5 && hour < 10) return { 
      ...
      mesh: 'radial-gradient(circle at 0% 0%, rgba(251, 191, 36, 0.6) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(245, 158, 11, 0.4) 0%, transparent 50%)'
    };
    if (hour >= 10 && hour < 16) return { 
      base: '#38b4ca', // Day Indigo
      mesh: 'radial-gradient(circle at 0% 0%, rgba(253, 237, 7, 0.5) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(249, 249, 249, 0.4) 0%, transparent 50%)'
    };
    if (hour >= 16 && hour < 19) return { 
      base: '#f44a06', // Sunset Pink/Orange
      mesh: 'radial-gradient(circle at 0% 0%, rgba(90, 86, 66, 0.6) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(251, 248, 60, 0.4) 0%, transparent 50%)'
    };
    return { 
      base: '#020617', // Midnight Blue
      mesh: 'radial-gradient(circle at 0% 0%, rgba(56, 189, 248, 0.2) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(30, 64, 175, 0.3) 0%, transparent 50%)'
    };
  };
...
const currentTheme = getTheme();
 ...
 <Card className="mb-4 border-0 overflow-hidden" 
    ...
    <Card.Body className="p-0">
      ...
      {/* 2. Soft Mesh Lighting (SEKARANG PAKAI THEME OTOMATIS) */}
        ...
        <Row className="align-items-center g-5">
          ...
          <Col lg={6} className="text-center text-md-start">
            {/* <div className="d-flex align-items-center justify-content-center justify-content-md-start mb-4">
              ...
              <span className="text-white opacity-50 fw-bold small tracking-widest text-uppercase">Dashboard</span>
            </div> */}
            <div 
              ...
              onClick={playEagleSound} // LANGSUNG BUNYI AJA BRO!
            >
              <img 
                src={maskotImage}
                alt="Maskot Elang"
                style={{ 
                  ...
                  height: '150px',
                  objectFit: 'contain',
                  animation: 'eagle-glide 6s ease-in-out infinite',
                  opacity: 0.9,
                  transition: 'all 0.3s ease',
                  filter: 'drop-shadow(0 10px 20px rgba(0,0,0,0.3))'
                }}
                onMouseEnter={(e) => {
                  e.target.style.animation = 'eagle-hover 1s ease-in-out infinite';
                  e.target.style.transform = 'scale(1.1)';
                  e.target.style.filter = 'drop-shadow(0 20px 30px gold)';
                }}
                onMouseLeave={(e) => {
                  e.target.style.animation = 'eagle-glide 6s ease-in-out infinite';
            ...
            <h1 className="text-white fw-black mb-3" style={{ fontSize: 'calc(2rem + 1.5vw)', letterSpacing: '-2px', lineHeight: '1' }}>
              {userGreeting},<br />
              <span className="name-gradient">{userName}</span> {userIcon}
            </h1>

            <p className="fs-5 text-white opacity-60 fw-light pe-lg-5" style={{ lineHeight: '1.6' }}>
              {userMotivation}
            </p>
          </Col>

          {/* RIGHT: Floating Glass Clock Section */}
          <Col lg={6}>
            <div className="glass-card-main">
              {/* Clock & Date */}
              <div className="text-center mb-4">
                <h2 className="clock-display mb-0">{formatTime(time)}</h2>
                <div className="d-flex align-items-center justify-content-center opacity-50 text-white mt-1">
                  <div style={{ height: '1px', width: '20px', background: '#fff' }} className="me-2" />
                  <span className="text-uppercase small fw-bold tracking-tighter">{formatDate(time)}</span>
                  <div style={{ height: '1px', width: '20px', background: '#fff' }} className="ms-2" />
                </div>
              </div>

              {/* Character & Message */}
              <div className="glass-inner-box d-flex align-items-center">
                <div className="character-avatar me-3">
                  {character.emoji}
                </div>
                <div className="message-content">
                  <p className="mb-0 text-white small fw-medium opacity-90 italic">
                    "{character.message}"
                  </p>
                </div>
              </div>
    ...
    <style>
      {`
        ...
        .status-indicator .dot { width: 12px; height: 12px; background: #10B981; border-radius: 50%; }
        ...
        @keyframes status-ring { 0% { transform: scale(1); opacity: 1; } 100% { transform: scale(3); opacity: 0; } }
        ...
        /* Animasi melayang seperti elang terbang */
        ...
        /* Efek sayap mengepak (lebih hidup) */
        // @keyframes wing-flap {
        //   0%, 100% {
        ...
        @keyframes eagle-hover {
          ...
          50% {
            ...
            filter: drop-shadow(0 20px 25px gold);
          }
        }
      `}
    </style>
